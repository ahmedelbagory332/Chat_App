...
import comdd.example.simplechatapp.viewModel.viewModelFactory.SignUpActivityViewModelFactory
        ...
        if (view.id == R.id.buttonCancel) {
            ...
            when {
                ...
                confirmPassword.text.toString().trim()!=password.text.toString().trim() -> {
                    ...
                    signUpActivityViewModel.signUp(firstName.text.toString().trim(),email.text.toString().trim(),password.text.toString().trim())
                }
            }
        }
    }
